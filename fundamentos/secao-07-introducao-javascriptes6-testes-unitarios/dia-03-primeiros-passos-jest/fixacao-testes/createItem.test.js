...
describe("a função createItem", () => {
  it("cria um item válido", () => {
    ...
    expect(createItem('banana', 'kg', 1.99, 20)).toStrictEqual({name: 'banana', quantity: 20, unit: 'kg', price: 1.99});
  });
  ...
  it("Lança um erro se o nome do item não é uma string", () => {
    expect(() => { createItem(1, 'kg', 1.99) }).toThrow(new Error('O nome do item deve ser uma string'));
  });
